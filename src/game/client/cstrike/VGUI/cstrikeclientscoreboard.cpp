...
{
	m_teamDisplayT.playerDataColor = Color(150, 200, 255, 255);
	m_teamDisplayT.playerClanColor = Color(150, 200, 255, 255);

	m_teamDisplayCT.playerDataColor = Color(240, 90, 90, 255);
	m_teamDisplayCT.playerClanColor = Color(240, 90, 90, 255);
...
{
	// Swap team colors: use CT (blue) convars for Terrorists, and T (red) convars for Counter-Terrorists.
	m_teamDisplayT.playerDataColor.SetColor( cl_scoreboard_ct_color_red.GetInt(), cl_scoreboard_ct_color_green.GetInt(), cl_scoreboard_ct_color_blue.GetInt(), 255 );
	m_teamDisplayCT.playerDataColor.SetColor( cl_scoreboard_t_color_red.GetInt(), cl_scoreboard_t_color_green.GetInt(), cl_scoreboard_t_color_blue.GetInt(), 255 );
	...
	m_teamDisplayT.playerClanColor.SetColor( cl_scoreboard_clan_ct_color_red.GetInt(), cl_scoreboard_clan_ct_color_green.GetInt(), cl_scoreboard_clan_ct_color_blue.GetInt(), 255 );
	m_teamDisplayCT.playerClanColor.SetColor( cl_scoreboard_clan_t_color_red.GetInt(), cl_scoreboard_clan_t_color_green.GetInt(), cl_scoreboard_clan_t_color_blue.GetInt(), 255 );
