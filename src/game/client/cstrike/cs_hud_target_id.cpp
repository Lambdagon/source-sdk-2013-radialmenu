...
void CTargetID::ApplySchemeSettings( vgui::IScheme *scheme )
{
	...
	// Swap team colors: use CT blue for Terrorists and T red for Counter-Terrorists.
	m_cTerroristColor = scheme->GetColor( "CT_Blue", Color( 255, 64, 64, 255 ) );
	m_cCTColor = scheme->GetColor( "T_Red", Color( 255, 64, 64, 255 ) );
