...
AI_BEGIN_CUSTOM_NPC( npc_infected, CNPC_Infected )
	...
	DECLARE_ACTIVITY( ACT_TERROR_SHOVED_BACKWARD )
	DECLARE_ACTIVITY( ACT_TERROR_SHOVED_FORWARD )
	DECLARE_ACTIVITY( ACT_TERROR_SHOVED_LEFTWARD )
	DECLARE_ACTIVITY( ACT_TERROR_SHOVED_RIGHTWARD )
