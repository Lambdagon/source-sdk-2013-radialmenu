...
public:
	...
	virtual float		GetFlameSpreadDelay();
...
private:
	...
	struct AcidVictimInfo_t
	{
		EHANDLE hVictim;
		float flEnterTime;
		float flLastTouchTime;
		bool bSpokeGooed;
	};

	CUtlVector< AcidVictimInfo_t > m_acidVictims;

	CSoundPatch *m_pSpitterSpitMusic;
	bool m_bSpitterSpitMusicFading;
