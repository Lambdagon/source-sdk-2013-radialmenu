...
//===========================
	...
	// Terror-Strike definitions
	ADD_ACTIVITY_TO_SR(ACT_TERROR_SHOVED_BACKWARD);
	ADD_ACTIVITY_TO_SR(ACT_TERROR_SHOVED_FORWARD);
	ADD_ACTIVITY_TO_SR(ACT_TERROR_SHOVED_RIGHTWARD);
	ADD_ACTIVITY_TO_SR(ACT_TERROR_SHOVED_LEFTWARD);
	...
	ADD_ACTIVITY_TO_SR( ACT_CALL_FOR_RESCUE );
	ADD_ACTIVITY_TO_SR( ACT_CROUCHIDLE_AXE );
	ADD_ACTIVITY_TO_SR( ACT_CROUCHIDLE_BAT );
	ADD_ACTIVITY_TO_SR( ACT_CROUCHIDLE_ELITES );
	ADD_ACTIVITY_TO_SR( ACT_CROUCHIDLE_FIRSTAIDKIT );
	ADD_ACTIVITY_TO_SR( ACT_CROUCHIDLE_FRYING_PAN );
	ADD_ACTIVITY_TO_SR( ACT_CROUCHIDLE_GASCAN );
	ADD_ACTIVITY_TO_SR( ACT_CROUCHIDLE_GREN );
	ADD_ACTIVITY_TO_SR( ACT_CROUCHIDLE_GREN_PULL_BACK );
	ADD_ACTIVITY_TO_SR( ACT_CROUCHIDLE_O2 );
	ADD_ACTIVITY_TO_SR( ACT_CROUCHIDLE_PISTOL );
	ADD_ACTIVITY_TO_SR( ACT_CROUCHIDLE_PUMPSHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_CROUCHIDLE_RIFLE );
	ADD_ACTIVITY_TO_SR( ACT_CROUCHIDLE_SECONDARY );
	ADD_ACTIVITY_TO_SR( ACT_CROUCHIDLE_SHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_CROUCHIDLE_SNIPER );
	ADD_ACTIVITY_TO_SR( ACT_CROUCHIDLE_SNIPER_MILITARY );
	ADD_ACTIVITY_TO_SR( ACT_CROUCHIDLE_SNIPER_MILITARYZOOMED );
	ADD_ACTIVITY_TO_SR( ACT_CROUCHIDLE_SNIPER_ZOOMED );
	ADD_ACTIVITY_TO_SR( ACT_DEPLOY_GREN );
	ADD_ACTIVITY_TO_SR( ACT_DEPLOY_SHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_DIE_INCAP );
	ADD_ACTIVITY_TO_SR( ACT_IDLE_AXE );
	ADD_ACTIVITY_TO_SR( ACT_IDLE_BAT );
	ADD_ACTIVITY_TO_SR( ACT_IDLE_CALM_AXE );
	ADD_ACTIVITY_TO_SR( ACT_IDLE_CALM_BAT );
	ADD_ACTIVITY_TO_SR( ACT_IDLE_CALM_ELITES );
	ADD_ACTIVITY_TO_SR( ACT_IDLE_CALM_FRYINGPAN );
	ADD_ACTIVITY_TO_SR( ACT_IDLE_CALM_GASCAN );
	ADD_ACTIVITY_TO_SR( ACT_IDLE_CALM_O2 );
	ADD_ACTIVITY_TO_SR( ACT_IDLE_CALM_PISTOL );
	ADD_ACTIVITY_TO_SR( ACT_IDLE_CALM_PUMPSHOTGUN );
	...
	ADD_ACTIVITY_TO_SR( ACT_IDLE_CALM_SNIPER_MILITARY );
	ADD_ACTIVITY_TO_SR( ACT_IDLE_ELITES );
	ADD_ACTIVITY_TO_SR( ACT_IDLE_FIRSTAIDKIT );
	ADD_ACTIVITY_TO_SR( ACT_IDLE_FRYING_PAN );
	ADD_ACTIVITY_TO_SR( ACT_IDLE_GASCAN );
	ADD_ACTIVITY_TO_SR( ACT_IDLE_GASCAN_PULL_BACK );
	ADD_ACTIVITY_TO_SR( ACT_IDLE_GREN );
	ADD_ACTIVITY_TO_SR( ACT_IDLE_GREN_PULL_BACK );
	ADD_ACTIVITY_TO_SR( ACT_IDLE_INJURED_AXE );
	ADD_ACTIVITY_TO_SR( ACT_IDLE_INJURED_BAT );
	ADD_ACTIVITY_TO_SR( ACT_IDLE_INJURED_ELITES );
	ADD_ACTIVITY_TO_SR( ACT_IDLE_INJURED_FIRSTAIDKIT );
	ADD_ACTIVITY_TO_SR( ACT_IDLE_INJURED_FRYINGPAN );
	ADD_ACTIVITY_TO_SR( ACT_IDLE_INJURED_GASCAN );
	ADD_ACTIVITY_TO_SR( ACT_IDLE_INJURED_GREN );
	ADD_ACTIVITY_TO_SR( ACT_IDLE_INJURED_GREN_PULL_BACK );
	ADD_ACTIVITY_TO_SR( ACT_IDLE_INJURED_O2 );
	ADD_ACTIVITY_TO_SR( ACT_IDLE_INJURED_PISTOL );
	ADD_ACTIVITY_TO_SR( ACT_IDLE_INJURED_PUMPSHOTGUN );
	...
	ADD_ACTIVITY_TO_SR( ACT_IDLE_INJURED_SNIPER_MILITARY );
	ADD_ACTIVITY_TO_SR( ACT_IDLE_INJURED_SNIPER_MILITARYZOOMED );
	ADD_ACTIVITY_TO_SR( ACT_IDLE_INJURED_SNIPER_ZOOMED );
	ADD_ACTIVITY_TO_SR( ACT_IDLE_MINIGUN );
	ADD_ACTIVITY_TO_SR( ACT_IDLE_O2 );
	ADD_ACTIVITY_TO_SR( ACT_IDLE_PUMPSHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_IDLE_SNIPER );
	ADD_ACTIVITY_TO_SR( ACT_IDLE_SNIPER_MILITARY );
	ADD_ACTIVITY_TO_SR( ACT_IDLE_SNIPER_MILITARYZOOMED );
	ADD_ACTIVITY_TO_SR( ACT_IDLE_SNIPER_ZOOMED );
	ADD_ACTIVITY_TO_SR( ACT_IDLE_o2_PULL_BACK );
	ADD_ACTIVITY_TO_SR( ACT_JUMP_AXE );
	ADD_ACTIVITY_TO_SR( ACT_JUMP_BAT );
	ADD_ACTIVITY_TO_SR( ACT_JUMP_DUAL_PISTOL );
	ADD_ACTIVITY_TO_SR( ACT_JUMP_FRYINGPAN );
	ADD_ACTIVITY_TO_SR( ACT_JUMP_GASCAN );
	ADD_ACTIVITY_TO_SR( ACT_JUMP_ITEM );
	ADD_ACTIVITY_TO_SR( ACT_JUMP_O2 );
	ADD_ACTIVITY_TO_SR( ACT_JUMP_RIFLE );
	ADD_ACTIVITY_TO_SR( ACT_JUMP_SHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_JUMP_SMG );
	ADD_ACTIVITY_TO_SR( ACT_JUMP_SMG2 );
	ADD_ACTIVITY_TO_SR( ACT_MELEE_STOMP_RIFLE_IDLE );
	ADD_ACTIVITY_TO_SR( ACT_MELEE_STOMP_RIFLE_WALK );
	ADD_ACTIVITY_TO_SR( ACT_MELEE_SWEEP_GASCAN );
	ADD_ACTIVITY_TO_SR( ACT_MELEE_SWEEP_O2 );
	ADD_ACTIVITY_TO_SR( ACT_PRIMARYATTACK_GASCAN1_IDLE );
	ADD_ACTIVITY_TO_SR( ACT_PRIMARYATTACK_GASCAN1_RUN );
	ADD_ACTIVITY_TO_SR( ACT_PRIMARYATTACK_GASCAN2_IDLE );
	ADD_ACTIVITY_TO_SR( ACT_PRIMARYATTACK_GASCAN2_RUN );
	ADD_ACTIVITY_TO_SR( ACT_PRIMARYATTACK_GREN1_IDLE );
	ADD_ACTIVITY_TO_SR( ACT_PRIMARYATTACK_GREN1_RUN );
	ADD_ACTIVITY_TO_SR( ACT_PRIMARYATTACK_GREN2_IDLE );
	ADD_ACTIVITY_TO_SR( ACT_PRIMARYATTACK_GREN2_RUN );
	ADD_ACTIVITY_TO_SR( ACT_PRIMARYATTACK_M3S90 );
	ADD_ACTIVITY_TO_SR( ACT_PRIMARYATTACK_MINIGUN );
	ADD_ACTIVITY_TO_SR( ACT_PRIMARYATTACK_PISTOL );
	ADD_ACTIVITY_TO_SR( ACT_PRIMARYATTACK_PUMPSHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_PRIMARYATTACK_RIFLE );
	ADD_ACTIVITY_TO_SR( ACT_PRIMARYATTACK_SMG );
	ADD_ACTIVITY_TO_SR( ACT_PRIMARYATTACK_XM1014 );
	ADD_ACTIVITY_TO_SR( ACT_PRIMARYATTACK_o21_IDLE );
	ADD_ACTIVITY_TO_SR( ACT_PRIMARYATTACK_o21_RUN );
	ADD_ACTIVITY_TO_SR( ACT_PRIMARYATTACK_o22_IDLE );
	ADD_ACTIVITY_TO_SR( ACT_PRIMARYATTACK_o22_RUN );
	ADD_ACTIVITY_TO_SR( ACT_RELOAD_ELITES );
	ADD_ACTIVITY_TO_SR( ACT_RELOAD_M4 );
	ADD_ACTIVITY_TO_SR( ACT_RELOAD_PUMPSHOTGUN_END );
	ADD_ACTIVITY_TO_SR( ACT_RELOAD_PUMPSHOTGUN_LOOP );
	ADD_ACTIVITY_TO_SR( ACT_RELOAD_PUMPSHOTGUN_START );
	ADD_ACTIVITY_TO_SR( ACT_RELOAD_RIFLE );
	ADD_ACTIVITY_TO_SR( ACT_RELOAD_SMG );
	ADD_ACTIVITY_TO_SR( ACT_RELOAD_SHOTGUN_END );
	ADD_ACTIVITY_TO_SR( ACT_RELOAD_SHOTGUN_LOOP );
	ADD_ACTIVITY_TO_SR( ACT_RELOAD_SHOTGUN_START );
	ADD_ACTIVITY_TO_SR( ACT_RELOAD_grenade_launcher );
	ADD_ACTIVITY_TO_SR( ACT_RUN_AXE );
	ADD_ACTIVITY_TO_SR( ACT_RUN_BAT );
	ADD_ACTIVITY_TO_SR( ACT_RUN_CALM_ELITES );
	ADD_ACTIVITY_TO_SR( ACT_RUN_CALM_PISTOL );
	ADD_ACTIVITY_TO_SR( ACT_RUN_CALM_PUMPSHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_RUN_CALM_RIFLE );
	ADD_ACTIVITY_TO_SR( ACT_RUN_CALM_SMG );
	ADD_ACTIVITY_TO_SR( ACT_RUN_CALM_SNIPER );
	ADD_ACTIVITY_TO_SR( ACT_RUN_CALM_SNIPER_MILITARY );
	ADD_ACTIVITY_TO_SR( ACT_RUN_CROUCH_AXE );
	ADD_ACTIVITY_TO_SR( ACT_RUN_CROUCH_BAT );
	ADD_ACTIVITY_TO_SR( ACT_RUN_CROUCH_ELITES );
	ADD_ACTIVITY_TO_SR( ACT_RUN_CROUCH_FIRSTAIDKIT );
	ADD_ACTIVITY_TO_SR( ACT_RUN_CROUCH_FRYING_PAN );
	ADD_ACTIVITY_TO_SR( ACT_RUN_CROUCH_GASCAN );
	ADD_ACTIVITY_TO_SR( ACT_RUN_CROUCH_GREN );
	ADD_ACTIVITY_TO_SR( ACT_RUN_CROUCH_O2 );
	ADD_ACTIVITY_TO_SR( ACT_RUN_CROUCH_PISTOL );
	ADD_ACTIVITY_TO_SR( ACT_RUN_CROUCH_PUMPSHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_RUN_CROUCH_SHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_RUN_CROUCH_SMG );
	ADD_ACTIVITY_TO_SR( ACT_RUN_CROUCH_SNIPER );
	ADD_ACTIVITY_TO_SR( ACT_RUN_CROUCH_SNIPER_MILITARY );
	ADD_ACTIVITY_TO_SR( ACT_RUN_ELITES );
	ADD_ACTIVITY_TO_SR( ACT_RUN_FIRSTAIDKIT );
	ADD_ACTIVITY_TO_SR( ACT_RUN_FRYING_PAN );
	ADD_ACTIVITY_TO_SR( ACT_RUN_GASCAN );
	ADD_ACTIVITY_TO_SR( ACT_RUN_GREN );
	ADD_ACTIVITY_TO_SR( ACT_RUN_INJURED_AXE );
	ADD_ACTIVITY_TO_SR( ACT_RUN_INJURED_BAT );
	ADD_ACTIVITY_TO_SR( ACT_RUN_INJURED_ELITES );
	ADD_ACTIVITY_TO_SR( ACT_RUN_INJURED_FIRSTAIDKIT );
	ADD_ACTIVITY_TO_SR( ACT_RUN_INJURED_FRYINGPAN );
	ADD_ACTIVITY_TO_SR( ACT_RUN_INJURED_GASCAN );
	ADD_ACTIVITY_TO_SR( ACT_RUN_INJURED_GREN );
	ADD_ACTIVITY_TO_SR( ACT_RUN_INJURED_O2 );
	ADD_ACTIVITY_TO_SR( ACT_RUN_INJURED_PISTOL );
	ADD_ACTIVITY_TO_SR( ACT_RUN_INJURED_PUMPSHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_RUN_INJURED_RIFLE );
	ADD_ACTIVITY_TO_SR( ACT_RUN_INJURED_SMG );
	ADD_ACTIVITY_TO_SR( ACT_RUN_INJURED_SNIPER );
	ADD_ACTIVITY_TO_SR( ACT_RUN_INJURED_SNIPER_MILITARY );
	ADD_ACTIVITY_TO_SR( ACT_RUN_O2 );
	ADD_ACTIVITY_TO_SR( ACT_RUN_PUMPSHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_RUN_SHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_RUN_SMG );
	ADD_ACTIVITY_TO_SR( ACT_RUN_SNIPER );
	ADD_ACTIVITY_TO_SR( ACT_RUN_SNIPER_MILITARY );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_CHOKING_TONGUE_GROUND );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_CROUCH_HEAL_FRIEND );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_CROUCH_HEAL_INCAPACITATED );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_CROUCH_HEAL_INCAPACITATED_ABOVE );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_CROUCH_HEAL_SELF );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_DRAGGING_FROM_TONGUE );
	...
	ADD_ACTIVITY_TO_SR( ACT_TERROR_HANGING_FROM_TONGUE );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_HEAL_FRIEND );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_HEAL_INCAPACITATED );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_HEAL_INCAPACITATED_ABOVE );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_HEAL_SELF );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_HIT_BY_TANKPUNCH );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_IDLE_FALL_FROM_TANKPUNCH );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_IDLE_FALL_FROM_TONGUE );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_IDLE_LADDER );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_INCAP_CRAWL );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_INCAP_FROM_POUNCE );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_INCAP_FROM_TONGUE );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_INCAP_TO_CROUCH );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_ITEM_PICKUP );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_JUMP_LANDING_HARD );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_LEDGE_CLIMB );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_LEDGE_CLIMB_TO_CROUCH );
	...
	ADD_ACTIVITY_TO_SR( ACT_TERROR_POUNCED_TO_STAND );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_PULLED_RUN_RIFLE );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_STANDING_CHOKE_FROM_TONGUE );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_TANKPUNCH_LAND );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_TANKROCK_TO_STAND );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_TUG );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_TUGGED_BACKWARD );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_TUGGED_FORWARD );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_TUGGED_LEFTWARD );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_TUGGED_RIGHTWARD );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_USE_GAS_CAN );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_USE_PILLS );
	ADD_ACTIVITY_TO_SR( ACT_WALK_AXE );
	ADD_ACTIVITY_TO_SR( ACT_WALK_BAT );
	ADD_ACTIVITY_TO_SR( ACT_WALK_CALM_ELITES );
	ADD_ACTIVITY_TO_SR( ACT_WALK_CALM_PISTOL );
	ADD_ACTIVITY_TO_SR( ACT_WALK_CALM_PUMPSHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_WALK_CALM_RIFLE );
	ADD_ACTIVITY_TO_SR( ACT_WALK_CALM_SMG );
	ADD_ACTIVITY_TO_SR( ACT_WALK_CALM_SNIPER );
	ADD_ACTIVITY_TO_SR( ACT_WALK_CALM_SNIPER_MILITARY );
	ADD_ACTIVITY_TO_SR( ACT_WALK_ELITES );
	ADD_ACTIVITY_TO_SR( ACT_WALK_FIRSTAIDKIT );
	ADD_ACTIVITY_TO_SR( ACT_WALK_FRYINGPAN );
	ADD_ACTIVITY_TO_SR( ACT_WALK_GASCAN );
	ADD_ACTIVITY_TO_SR( ACT_WALK_GREN );
	ADD_ACTIVITY_TO_SR( ACT_WALK_INJURED_AXE );
	ADD_ACTIVITY_TO_SR( ACT_WALK_INJURED_BAT );
	ADD_ACTIVITY_TO_SR( ACT_WALK_INJURED_ELITES );
	ADD_ACTIVITY_TO_SR( ACT_WALK_INJURED_FIRSTAIDKIT );
	ADD_ACTIVITY_TO_SR( ACT_WALK_INJURED_FRYINGPAN );
	ADD_ACTIVITY_TO_SR( ACT_WALK_INJURED_GREN );
	ADD_ACTIVITY_TO_SR( ACT_WALK_INJURED_GasCan );
	ADD_ACTIVITY_TO_SR( ACT_WALK_INJURED_O2 );
	ADD_ACTIVITY_TO_SR( ACT_WALK_INJURED_PISTOL );
	ADD_ACTIVITY_TO_SR( ACT_WALK_INJURED_PUMPSHOTGUN );
	...
	ADD_ACTIVITY_TO_SR( ACT_WALK_INJURED_SNIPER_MILITARY );
	ADD_ACTIVITY_TO_SR( ACT_WALK_O2 );
	ADD_ACTIVITY_TO_SR( ACT_WALK_PUMPSHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_WALK_SHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_WALK_SMG );
	ADD_ACTIVITY_TO_SR( ACT_WALK_SNIPER );
	ADD_ACTIVITY_TO_SR( ACT_WALK_SNIPER_MILITARY );
	...
	ADD_ACTIVITY_TO_SR( ACT_TERROR_CARRIED );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_SLAMMED_GROUND );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_CHARGER_POUNDED_DOWN );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_CHARGER_CHARGE );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_SLAM_GROUND );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_CHARGER_POUND_DOWN );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_CHARGER_POUND_DOWN_COACH );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_CHARGER_POUND_DOWN_PRODUCER );
	ADD_ACTIVITY_TO_SR( ACT_TANK_OVERHEAD_THROW );
	ADD_ACTIVITY_TO_SR(ACT_VM_VOMIT);
	ADD_ACTIVITY_TO_SR(ACT_VM_MELEE);
	ADD_ACTIVITY_TO_SR(ACT_VM_LUNGE);
	ADD_ACTIVITY_TO_SR(ACT_VM_LUNGE_OFFWALL);
	ADD_ACTIVITY_TO_SR(ACT_VM_LUNGE_PUSH);
	ADD_ACTIVITY_TO_SR(ACT_VM_LUNGE_POUNCE);
	ADD_ACTIVITY_TO_SR( ACT_VM_DRAW_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_HOLSTER_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_FIDGET_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_PULLBACK_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_PULLBACK_HIGH_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_PULLBACK_LOW_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_THROW_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_PULLPIN_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_PRIMARYATTACK_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_SECONDARYATTACK_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_RELOAD_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_RELOAD_START_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_RELOAD_FINISH_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_DRYFIRE_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_HITLEFT_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_HITLEFT2_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_HITRIGHT_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_HITRIGHT2_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_HITCENTER_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_HITCENTER2_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_MISSLEFT_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_MISSLEFT2_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_MISSRIGHT_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_MISSRIGHT2_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_MISSCENTER_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_MISSCENTER2_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_HAULBACK_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_SWINGHARD_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_SWINGMISS_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_SWINGHIT_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_IDLE_TO_LOWERED_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_IDLE_LOWERED_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_LOWERED_TO_IDLE_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_RECOIL1_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_RECOIL2_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_RECOIL3_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_PICKUP_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_RELEASE_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_ATTACH_SILENCER_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_DETACH_SILENCER_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_DRAW_SPECIAL_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_HOLSTER_SPECIAL_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_IDLE_SPECIAL_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_PULLBACK_SPECIAL_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_PRIMARYATTACK_SPECIAL_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_SECONDARYATTACK_SPECIAL_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_HITCENTER_SPECIAL_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_SWINGHARD_SPECIAL_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_IDLE_TO_LOWERED_SPECIAL_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_IDLE_LOWERED_SPECIAL_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_LOWERED_TO_IDLE_SPECIAL_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_SPRINT_ENTER_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_SPRINT_IDLE_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_SPRINT_LEAVE_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_PRIMARYATTACK_SILENCED_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_RELOAD_SILENCED_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_DRYFIRE_SILENCED_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_IDLE_SILENCED_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_DRAW_SILENCED_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_IDLE_EMPTY_LEFT_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_DRYFIRE_LEFT_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_RELOAD_DEPLOYED_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_RELOAD_IDLE_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_DRAW_DEPLOYED_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_DRAW_EMPTY_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_PRIMARYATTACK_EMPTY_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_RELOAD_EMPTY_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_IDLE_EMPTY_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_IDLE_DEPLOYED_EMPTY_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_IDLE_8_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_IDLE_7_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_IDLE_6_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_IDLE_5_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_IDLE_4_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_IDLE_3_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_IDLE_2_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_IDLE_1_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_IDLE_DEPLOYED_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_IDLE_DEPLOYED_8_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_IDLE_DEPLOYED_7_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_IDLE_DEPLOYED_6_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_IDLE_DEPLOYED_5_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_IDLE_DEPLOYED_4_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_IDLE_DEPLOYED_3_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_IDLE_DEPLOYED_2_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_IDLE_DEPLOYED_1_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_UNDEPLOY_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_UNDEPLOY_8_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_UNDEPLOY_7_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_UNDEPLOY_6_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_UNDEPLOY_5_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_UNDEPLOY_4_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_UNDEPLOY_3_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_UNDEPLOY_2_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_UNDEPLOY_1_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_UNDEPLOY_EMPTY_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_DEPLOY_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_DEPLOY_8_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_DEPLOY_7_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_DEPLOY_6_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_DEPLOY_5_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_DEPLOY_4_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_DEPLOY_3_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_DEPLOY_2_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_DEPLOY_1_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_DEPLOY_EMPTY_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_PRIMARYATTACK_8_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_PRIMARYATTACK_7_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_PRIMARYATTACK_6_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_PRIMARYATTACK_5_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_PRIMARYATTACK_4_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_PRIMARYATTACK_3_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_PRIMARYATTACK_2_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_PRIMARYATTACK_1_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_PRIMARYATTACK_DEPLOYED_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_PRIMARYATTACK_DEPLOYED_8_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_PRIMARYATTACK_DEPLOYED_7_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_PRIMARYATTACK_DEPLOYED_6_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_PRIMARYATTACK_DEPLOYED_5_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_PRIMARYATTACK_DEPLOYED_4_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_PRIMARYATTACK_DEPLOYED_3_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_PRIMARYATTACK_DEPLOYED_2_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_PRIMARYATTACK_DEPLOYED_1_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_PRIMARYATTACK_DEPLOYED_EMPTY_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_FIZZLE_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_UNUSABLE_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_UNUSABLE_TO_USABLE_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_USABLE_TO_UNUSABLE_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_DRAW_QRL_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_IDLE_QRL_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_PULLBACK_QRL_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_PRIMARYATTACK_QRL_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_RELOAD_QRL_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_RELOAD_START_QRL_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_RELOAD_FINISH_QRL_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_VOMIT_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_MELEE_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_LUNGE_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_LUNGE_OFFWALL_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_LUNGE_PUSH_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_LUNGE_POUNCE_LAYER );
	ADD_ACTIVITY_TO_SR(ACT_PRIMARYATTACK);
	ADD_ACTIVITY_TO_SR(ACT_SECONDARYATTACK);
	ADD_ACTIVITY_TO_SR(ACT_VM_RELOAD_LOOP);
	ADD_ACTIVITY_TO_SR(ACT_VM_RELOAD_LOOP_LAYER);
	ADD_ACTIVITY_TO_SR(ACT_VM_SHOOT_LAYER);
	ADD_ACTIVITY_TO_SR(ACT_VM_IDLE_GASCAN);
	ADD_ACTIVITY_TO_SR(ACT_VM_DEPLOY_GASCAN);
	ADD_ACTIVITY_TO_SR(ACT_VM_PULLPIN_GASCAN);
	ADD_ACTIVITY_TO_SR(ACT_VM_THROW_GASCAN);
	ADD_ACTIVITY_TO_SR(ACT_VM_MELEE_GASCAN);
	ADD_ACTIVITY_TO_SR(ACT_VM_IDLE_PAINPILLS);
	ADD_ACTIVITY_TO_SR(ACT_VM_DEPLOY_PAINPILLS);
	ADD_ACTIVITY_TO_SR(ACT_VM_MELEE_PAINPILLS);
	ADD_ACTIVITY_TO_SR(ACT_VM_ITEMPICKUP_LOOP_PAINPILLS);
	ADD_ACTIVITY_TO_SR(ACT_VM_ITEMPICKUP_EXTEND_PAINPILLS);
	ADD_ACTIVITY_TO_SR(ACT_VM_ITEMPICKUP_RETRACT_PAINPILLS);
	ADD_ACTIVITY_TO_SR(ACT_VM_HELPINGHAND_LOOP_PAINPILLS);
	ADD_ACTIVITY_TO_SR(ACT_VM_HELPINGHAND_EXTEND_PAINPILLS);
	ADD_ACTIVITY_TO_SR(ACT_VM_HELPINGHAND_RETRACT_PAINPILLS);
	ADD_ACTIVITY_TO_SR(ACT_VM_USE_PAINPILLS);
}
