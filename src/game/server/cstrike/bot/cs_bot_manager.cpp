...
//--------------------------------------------------------------------------------------------------------------
CON_COMMAND_F( bot_add, "bot_add <t|ct> <type> <difficulty> <name> - Adds a bot matching the given criteria.", FCVAR_GAMEDLL|FCVAR_HIDDEN )
{
...
//--------------------------------------------------------------------------------------------------------------
CON_COMMAND_F( sb_add, "sb_add <type> <difficulty> <name> - Adds a survivor bot matching the given criteria.", FCVAR_GAMEDLL )
{
	if ( !UTIL_IsCommandIssuedByServerAdmin() )
		return;
...
//--------------------------------------------------------------------------------------------------------------
CON_COMMAND_F( bot_add_ct, "bot_add_ct <type> <difficulty> <name> - Adds a Counter-Terrorist bot matching the given criteria.", FCVAR_GAMEDLL | FCVAR_HIDDEN)
{
	if ( !UTIL_IsCommandIssuedByServerAdmin() )
		return;
