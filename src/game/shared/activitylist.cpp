...
Activity Activity_LayerForViewModel( Activity activity )
{
	if ( activity == ACT_INVALID || activity == ACT_VM_IDLE )
		return ACT_INVALID;

	const char *pszActivityName = ActivityList_NameForIndex( activity );
	if ( pszActivityName == NULL || Q_strncmp( pszActivityName, "ACT_VM_", 7 ) != 0 )
		return ACT_INVALID;

	if ( Q_strstr( pszActivityName, "_LAYER" ) != NULL )
		return activity;

	char szLayeredActivity[128];
	Q_snprintf( szLayeredActivity, sizeof( szLayeredActivity ), "%s_LAYER", pszActivityName );

	const int iLayeredActivity = ActivityList_IndexForName( szLayeredActivity );
	return iLayeredActivity >= 0 ? (Activity)iLayeredActivity : ACT_INVALID;
}

int SelectWeightedSequenceForViewModel( CBaseAnimating *pAnimating, Activity activity )
{
	if ( pAnimating == NULL )
		return ACTIVITY_NOT_AVAILABLE;

	const Activity layeredActivity = Activity_LayerForViewModel( activity );
	if ( layeredActivity != ACT_INVALID )
	{
		const int layeredSequence = pAnimating->SelectWeightedSequence( layeredActivity );
		if ( layeredSequence != ACTIVITY_NOT_AVAILABLE )
			return layeredSequence;
	}

	return pAnimating->SelectWeightedSequence( activity );
}
...
//HL2MP
	...
	REGISTER_SHARED_ACTIVITY(ACT_TERROR_SHOVED_BACKWARD);
	REGISTER_SHARED_ACTIVITY(ACT_TERROR_SHOVED_FORWARD);
	REGISTER_SHARED_ACTIVITY(ACT_TERROR_SHOVED_RIGHTWARD);
	REGISTER_SHARED_ACTIVITY(ACT_TERROR_SHOVED_LEFTWARD);
	...
	REGISTER_SHARED_ACTIVITY( ACT_CALL_FOR_RESCUE );
	REGISTER_SHARED_ACTIVITY( ACT_CROUCHIDLE_AXE );
	REGISTER_SHARED_ACTIVITY( ACT_CROUCHIDLE_BAT );
	REGISTER_SHARED_ACTIVITY( ACT_CROUCHIDLE_ELITES );
	REGISTER_SHARED_ACTIVITY( ACT_CROUCHIDLE_FIRSTAIDKIT );
	REGISTER_SHARED_ACTIVITY( ACT_CROUCHIDLE_FRYING_PAN );
	REGISTER_SHARED_ACTIVITY( ACT_CROUCHIDLE_GASCAN );
	REGISTER_SHARED_ACTIVITY( ACT_CROUCHIDLE_GREN );
	REGISTER_SHARED_ACTIVITY( ACT_CROUCHIDLE_GREN_PULL_BACK );
	REGISTER_SHARED_ACTIVITY( ACT_CROUCHIDLE_O2 );
	REGISTER_SHARED_ACTIVITY( ACT_CROUCHIDLE_PISTOL );
	REGISTER_SHARED_ACTIVITY( ACT_CROUCHIDLE_PUMPSHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_CROUCHIDLE_RIFLE );
	REGISTER_SHARED_ACTIVITY( ACT_CROUCHIDLE_SECONDARY );
	REGISTER_SHARED_ACTIVITY( ACT_CROUCHIDLE_SHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_CROUCHIDLE_SNIPER );
	REGISTER_SHARED_ACTIVITY( ACT_CROUCHIDLE_SNIPER_MILITARY );
	REGISTER_SHARED_ACTIVITY( ACT_CROUCHIDLE_SNIPER_MILITARYZOOMED );
	REGISTER_SHARED_ACTIVITY( ACT_CROUCHIDLE_SNIPER_ZOOMED );
	REGISTER_SHARED_ACTIVITY( ACT_DEPLOY_GREN );
	REGISTER_SHARED_ACTIVITY( ACT_DEPLOY_SHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_DIE_INCAP );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_AXE );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_BAT );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_CALM_AXE );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_CALM_BAT );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_CALM_ELITES );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_CALM_FRYINGPAN );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_CALM_GASCAN );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_CALM_O2 );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_CALM_PISTOL );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_CALM_PUMPSHOTGUN );
	...
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_CALM_SNIPER_MILITARY );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_ELITES );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_FIRSTAIDKIT );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_FRYING_PAN );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_GASCAN );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_GASCAN_PULL_BACK );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_GREN );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_GREN_PULL_BACK );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_INJURED_AXE );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_INJURED_BAT );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_INJURED_ELITES );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_INJURED_FIRSTAIDKIT );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_INJURED_FRYINGPAN );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_INJURED_GASCAN );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_INJURED_GREN );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_INJURED_GREN_PULL_BACK );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_INJURED_O2 );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_INJURED_PISTOL );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_INJURED_PUMPSHOTGUN );
	...
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_INJURED_SNIPER_MILITARY );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_INJURED_SNIPER_MILITARYZOOMED );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_INJURED_SNIPER_ZOOMED );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_MINIGUN );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_O2 );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_PUMPSHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_SNIPER );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_SNIPER_MILITARY );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_SNIPER_MILITARYZOOMED );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_SNIPER_ZOOMED );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_o2_PULL_BACK );
	REGISTER_SHARED_ACTIVITY( ACT_JUMP_AXE );
	REGISTER_SHARED_ACTIVITY( ACT_JUMP_BAT );
	REGISTER_SHARED_ACTIVITY( ACT_JUMP_DUAL_PISTOL );
	REGISTER_SHARED_ACTIVITY( ACT_JUMP_FRYINGPAN );
	REGISTER_SHARED_ACTIVITY( ACT_JUMP_GASCAN );
	REGISTER_SHARED_ACTIVITY( ACT_JUMP_ITEM );
	REGISTER_SHARED_ACTIVITY( ACT_JUMP_O2 );
	REGISTER_SHARED_ACTIVITY( ACT_JUMP_RIFLE );
	REGISTER_SHARED_ACTIVITY( ACT_JUMP_SHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_JUMP_SMG );
	REGISTER_SHARED_ACTIVITY( ACT_JUMP_SMG2 );
	REGISTER_SHARED_ACTIVITY( ACT_JUMP_o2 );
	REGISTER_SHARED_ACTIVITY( ACT_MELEE_STOMP_RIFLE_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_MELEE_STOMP_RIFLE_WALK );
	REGISTER_SHARED_ACTIVITY( ACT_MELEE_SWEEP_GASCAN );
	REGISTER_SHARED_ACTIVITY( ACT_MELEE_SWEEP_O2 );
	REGISTER_SHARED_ACTIVITY( ACT_PRIMARYATTACK_GASCAN1_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_PRIMARYATTACK_GASCAN1_RUN );
	REGISTER_SHARED_ACTIVITY( ACT_PRIMARYATTACK_GASCAN2_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_PRIMARYATTACK_GASCAN2_RUN );
	REGISTER_SHARED_ACTIVITY( ACT_PRIMARYATTACK_GREN1_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_PRIMARYATTACK_GREN1_RUN );
	REGISTER_SHARED_ACTIVITY( ACT_PRIMARYATTACK_GREN2_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_PRIMARYATTACK_GREN2_RUN );
	REGISTER_SHARED_ACTIVITY( ACT_PRIMARYATTACK_M3S90 );
	REGISTER_SHARED_ACTIVITY( ACT_PRIMARYATTACK_MINIGUN );
	REGISTER_SHARED_ACTIVITY( ACT_PRIMARYATTACK_PISTOL );
	REGISTER_SHARED_ACTIVITY( ACT_PRIMARYATTACK_PUMPSHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_PRIMARYATTACK_RIFLE );
	REGISTER_SHARED_ACTIVITY( ACT_PRIMARYATTACK_SMG );
	REGISTER_SHARED_ACTIVITY( ACT_PRIMARYATTACK_XM1014 );
	REGISTER_SHARED_ACTIVITY( ACT_PRIMARYATTACK_o21_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_PRIMARYATTACK_o21_RUN );
	REGISTER_SHARED_ACTIVITY( ACT_PRIMARYATTACK_o22_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_PRIMARYATTACK_o22_RUN );
	REGISTER_SHARED_ACTIVITY( ACT_RELOAD_ELITES );
	REGISTER_SHARED_ACTIVITY( ACT_RELOAD_M4 );
	REGISTER_SHARED_ACTIVITY( ACT_RELOAD_PUMPSHOTGUN_END );
	REGISTER_SHARED_ACTIVITY( ACT_RELOAD_PUMPSHOTGUN_LOOP );
	REGISTER_SHARED_ACTIVITY( ACT_RELOAD_PUMPSHOTGUN_START );
	REGISTER_SHARED_ACTIVITY( ACT_RELOAD_RIFLE );
	REGISTER_SHARED_ACTIVITY( ACT_RELOAD_SMG );
	REGISTER_SHARED_ACTIVITY( ACT_RELOAD_SHOTGUN_END );
	REGISTER_SHARED_ACTIVITY( ACT_RELOAD_SHOTGUN_LOOP );
	REGISTER_SHARED_ACTIVITY( ACT_RELOAD_SHOTGUN_START );
	REGISTER_SHARED_ACTIVITY( ACT_RELOAD_grenade_launcher );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_AXE );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_BAT );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_CALM_ELITES );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_CALM_PISTOL );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_CALM_PUMPSHOTGUN );
	...
	REGISTER_SHARED_ACTIVITY( ACT_RUN_CALM_SNIPER_MILITARY );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_CROUCH_AXE );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_CROUCH_BAT );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_CROUCH_ELITES );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_CROUCH_FIRSTAIDKIT );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_CROUCH_FRYING_PAN );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_CROUCH_GASCAN );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_CROUCH_GREN );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_CROUCH_O2 );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_CROUCH_PISTOL );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_CROUCH_PUMPSHOTGUN );
	...
	REGISTER_SHARED_ACTIVITY( ACT_RUN_CROUCH_SNIPER_MILITARY );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_ELITES );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_FIRSTAIDKIT );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_FRYING_PAN );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_GASCAN );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_GREN );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_INJURED_AXE );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_INJURED_BAT );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_INJURED_ELITES );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_INJURED_FIRSTAIDKIT );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_INJURED_FRYINGPAN );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_INJURED_GASCAN );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_INJURED_GREN );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_INJURED_O2 );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_INJURED_PISTOL );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_INJURED_PUMPSHOTGUN );
	...
	REGISTER_SHARED_ACTIVITY( ACT_RUN_INJURED_SNIPER_MILITARY );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_O2 );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_PUMPSHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_SHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_SMG );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_SNIPER );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_SNIPER_MILITARY );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_CHOKING_TONGUE_GROUND );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_CROUCH_HEAL_FRIEND );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_CROUCH_HEAL_INCAPACITATED );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_CROUCH_HEAL_INCAPACITATED_ABOVE );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_CROUCH_HEAL_SELF );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_DRAGGING_FROM_TONGUE );
	...
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_HANGING_FROM_TONGUE );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_HEAL_FRIEND );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_HEAL_INCAPACITATED );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_HEAL_INCAPACITATED_ABOVE );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_HEAL_SELF );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_HIT_BY_TANKPUNCH );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_IDLE_FALL_FROM_TANKPUNCH );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_IDLE_FALL_FROM_TONGUE );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_IDLE_LADDER );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_INCAP_CRAWL );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_INCAP_FROM_POUNCE );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_INCAP_FROM_TONGUE );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_INCAP_TO_CROUCH );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_ITEM_PICKUP );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_JUMP_LANDING_HARD );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_LEDGE_CLIMB );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_LEDGE_CLIMB_TO_CROUCH );
	...
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_POUNCED_TO_STAND );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_PULLED_RUN_RIFLE );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_STANDING_CHOKE_FROM_TONGUE );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_TANKPUNCH_LAND );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_TANKROCK_TO_STAND );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_TUG );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_TUGGED_BACKWARD );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_TUGGED_FORWARD );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_TUGGED_LEFTWARD );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_TUGGED_RIGHTWARD );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_USE_GAS_CAN );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_USE_PILLS );
	REGISTER_SHARED_ACTIVITY( ACT_WALK_AXE );
	REGISTER_SHARED_ACTIVITY( ACT_WALK_BAT );
	REGISTER_SHARED_ACTIVITY( ACT_WALK_CALM_ELITES );
	REGISTER_SHARED_ACTIVITY( ACT_WALK_CALM_PISTOL );
	REGISTER_SHARED_ACTIVITY( ACT_WALK_CALM_PUMPSHOTGUN );
	...
	REGISTER_SHARED_ACTIVITY( ACT_WALK_CALM_SNIPER_MILITARY );
	REGISTER_SHARED_ACTIVITY( ACT_WALK_ELITES );
	REGISTER_SHARED_ACTIVITY( ACT_WALK_FIRSTAIDKIT );
	REGISTER_SHARED_ACTIVITY( ACT_WALK_FRYINGPAN );
	REGISTER_SHARED_ACTIVITY( ACT_WALK_GASCAN );
	REGISTER_SHARED_ACTIVITY( ACT_WALK_GREN );
	REGISTER_SHARED_ACTIVITY( ACT_WALK_INJURED_AXE );
	REGISTER_SHARED_ACTIVITY( ACT_WALK_INJURED_BAT );
	REGISTER_SHARED_ACTIVITY( ACT_WALK_INJURED_ELITES );
	REGISTER_SHARED_ACTIVITY( ACT_WALK_INJURED_FIRSTAIDKIT );
	REGISTER_SHARED_ACTIVITY( ACT_WALK_INJURED_FRYINGPAN );
	REGISTER_SHARED_ACTIVITY( ACT_WALK_INJURED_GREN );
	REGISTER_SHARED_ACTIVITY( ACT_WALK_INJURED_GasCan );
	REGISTER_SHARED_ACTIVITY( ACT_WALK_INJURED_O2 );
	REGISTER_SHARED_ACTIVITY( ACT_WALK_INJURED_PISTOL );
	REGISTER_SHARED_ACTIVITY( ACT_WALK_INJURED_PUMPSHOTGUN );
	...
	REGISTER_SHARED_ACTIVITY( ACT_WALK_INJURED_SNIPER_MILITARY );
	REGISTER_SHARED_ACTIVITY( ACT_WALK_O2 );
	REGISTER_SHARED_ACTIVITY( ACT_WALK_PUMPSHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_WALK_SHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_WALK_SMG );
	REGISTER_SHARED_ACTIVITY( ACT_WALK_SNIPER );
	REGISTER_SHARED_ACTIVITY( ACT_WALK_SNIPER_MILITARY );
	...
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_CARRIED );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_SLAMMED_GROUND );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_CHARGER_POUNDED_DOWN );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_CHARGER_CHARGE );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_SLAM_GROUND );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_CHARGER_POUND_DOWN );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_CHARGER_POUND_DOWN_COACH );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_CHARGER_POUND_DOWN_PRODUCER );
	REGISTER_SHARED_ACTIVITY( ACT_TANK_OVERHEAD_THROW );
	REGISTER_SHARED_ACTIVITY(ACT_VM_VOMIT);
	REGISTER_SHARED_ACTIVITY(ACT_VM_MELEE);
	REGISTER_SHARED_ACTIVITY(ACT_VM_LUNGE);
	REGISTER_SHARED_ACTIVITY(ACT_VM_LUNGE_OFFWALL);
	REGISTER_SHARED_ACTIVITY(ACT_VM_LUNGE_PUSH);
	REGISTER_SHARED_ACTIVITY(ACT_VM_LUNGE_POUNCE);
	REGISTER_SHARED_ACTIVITY( ACT_VM_DRAW_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_HOLSTER_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_FIDGET_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_PULLBACK_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_PULLBACK_HIGH_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_PULLBACK_LOW_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_THROW_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_PULLPIN_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_PRIMARYATTACK_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_SECONDARYATTACK_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_RELOAD_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_RELOAD_START_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_RELOAD_FINISH_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_DRYFIRE_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_HITLEFT_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_HITLEFT2_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_HITRIGHT_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_HITRIGHT2_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_HITCENTER_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_HITCENTER2_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_MISSLEFT_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_MISSLEFT2_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_MISSRIGHT_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_MISSRIGHT2_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_MISSCENTER_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_MISSCENTER2_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_HAULBACK_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_SWINGHARD_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_SWINGMISS_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_SWINGHIT_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_IDLE_TO_LOWERED_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_IDLE_LOWERED_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_LOWERED_TO_IDLE_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_RECOIL1_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_RECOIL2_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_RECOIL3_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_PICKUP_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_RELEASE_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_ATTACH_SILENCER_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_DETACH_SILENCER_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_DRAW_SPECIAL_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_HOLSTER_SPECIAL_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_IDLE_SPECIAL_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_PULLBACK_SPECIAL_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_PRIMARYATTACK_SPECIAL_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_SECONDARYATTACK_SPECIAL_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_HITCENTER_SPECIAL_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_SWINGHARD_SPECIAL_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_IDLE_TO_LOWERED_SPECIAL_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_IDLE_LOWERED_SPECIAL_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_LOWERED_TO_IDLE_SPECIAL_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_SPRINT_ENTER_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_SPRINT_IDLE_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_SPRINT_LEAVE_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_PRIMARYATTACK_SILENCED_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_RELOAD_SILENCED_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_DRYFIRE_SILENCED_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_IDLE_SILENCED_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_DRAW_SILENCED_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_IDLE_EMPTY_LEFT_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_DRYFIRE_LEFT_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_RELOAD_DEPLOYED_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_RELOAD_IDLE_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_DRAW_DEPLOYED_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_DRAW_EMPTY_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_PRIMARYATTACK_EMPTY_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_RELOAD_EMPTY_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_IDLE_EMPTY_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_IDLE_DEPLOYED_EMPTY_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_IDLE_8_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_IDLE_7_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_IDLE_6_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_IDLE_5_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_IDLE_4_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_IDLE_3_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_IDLE_2_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_IDLE_1_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_IDLE_DEPLOYED_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_IDLE_DEPLOYED_8_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_IDLE_DEPLOYED_7_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_IDLE_DEPLOYED_6_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_IDLE_DEPLOYED_5_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_IDLE_DEPLOYED_4_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_IDLE_DEPLOYED_3_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_IDLE_DEPLOYED_2_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_IDLE_DEPLOYED_1_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_UNDEPLOY_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_UNDEPLOY_8_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_UNDEPLOY_7_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_UNDEPLOY_6_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_UNDEPLOY_5_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_UNDEPLOY_4_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_UNDEPLOY_3_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_UNDEPLOY_2_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_UNDEPLOY_1_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_UNDEPLOY_EMPTY_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_DEPLOY_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_DEPLOY_8_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_DEPLOY_7_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_DEPLOY_6_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_DEPLOY_5_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_DEPLOY_4_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_DEPLOY_3_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_DEPLOY_2_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_DEPLOY_1_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_DEPLOY_EMPTY_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_PRIMARYATTACK_8_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_PRIMARYATTACK_7_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_PRIMARYATTACK_6_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_PRIMARYATTACK_5_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_PRIMARYATTACK_4_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_PRIMARYATTACK_3_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_PRIMARYATTACK_2_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_PRIMARYATTACK_1_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_PRIMARYATTACK_DEPLOYED_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_PRIMARYATTACK_DEPLOYED_8_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_PRIMARYATTACK_DEPLOYED_7_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_PRIMARYATTACK_DEPLOYED_6_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_PRIMARYATTACK_DEPLOYED_5_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_PRIMARYATTACK_DEPLOYED_4_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_PRIMARYATTACK_DEPLOYED_3_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_PRIMARYATTACK_DEPLOYED_2_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_PRIMARYATTACK_DEPLOYED_1_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_PRIMARYATTACK_DEPLOYED_EMPTY_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_FIZZLE_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_UNUSABLE_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_UNUSABLE_TO_USABLE_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_USABLE_TO_UNUSABLE_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_DRAW_QRL_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_IDLE_QRL_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_PULLBACK_QRL_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_PRIMARYATTACK_QRL_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_RELOAD_QRL_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_RELOAD_START_QRL_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_RELOAD_FINISH_QRL_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_VOMIT_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_MELEE_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_LUNGE_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_LUNGE_OFFWALL_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_LUNGE_PUSH_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_LUNGE_POUNCE_LAYER );
	REGISTER_SHARED_ACTIVITY(ACT_PRIMARYATTACK);
	REGISTER_SHARED_ACTIVITY(ACT_SECONDARYATTACK);
	REGISTER_SHARED_ACTIVITY(ACT_VM_RELOAD_LOOP);
	REGISTER_SHARED_ACTIVITY(ACT_VM_RELOAD_LOOP_LAYER);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SHOOT_LAYER);
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_POUNCED );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_HUNTER_POUNCE_MELEE );
