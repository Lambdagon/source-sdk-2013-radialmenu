...
const float CS_PLAYER_SPEED_RUN		 = 220.0f;
const float CS_PLAYER_SPEED_VIP		 = 227.0f;
const float CS_PLAYER_SPEED_WALK	 = 85.0f;
...
const float CS_PLAYER_SPEED_WALK_MODIFIER	= 0.38636f;
const float CS_PLAYER_SPEED_CLIMB_MODIFIER	= 0.34f;

const char* g_aPlayerClassNames_NonLocalized[11] =
{
	"Gambler",
	"Coach",
	"Mechanic",
