...
extern const char* g_aPlayerClassNames_NonLocalized[11];	// non-localized class names
...
#define	TEAM_CT					3
#define TEAM_SURVIVOR	TEAM_TERRORIST
#define TEAM_INFECTED	TEAM_CT
#define TEAM_ZOMBIE	TEAM_CT
...
// [menglish] CS specific death animation time now that freeze cam is implemented
//			in order to linger on the players body less 
#define CS_DEATH_ANIMATION_TIME			2.0
