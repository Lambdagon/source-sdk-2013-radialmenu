...
void EventList_RegisterSharedEvents( void )
{
	...
	REGISTER_SHARED_ANIMEVENT(AE_FOOTSTEP_LEFT, AE_TYPE_CLIENT);
	REGISTER_SHARED_ANIMEVENT(AE_FOOTSTEP_RIGHT, AE_TYPE_CLIENT);
	REGISTER_SHARED_ANIMEVENT(AE_ATTACK_HIT, AE_TYPE_SERVER);
	REGISTER_SHARED_ANIMEVENT( AE_ATTACK_END, AE_TYPE_SERVER );
	REGISTER_SHARED_ANIMEVENT( AE_CHARGER_POUND_VOCALIZE, AE_TYPE_SERVER );
	REGISTER_SHARED_ANIMEVENT( AE_CHARGER_POUND_IMPACT, AE_TYPE_SERVER );
}
