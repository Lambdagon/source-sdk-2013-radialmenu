...
const char *g_pszMPConcepts[] =
{
	...
	"ScreamWhilePounced",						// MP_CONCEPT_HURT
	...
	"PlayerCoverMe",				// MP_CONCEPT_PLAYER_MEDIC
	"TLK_DETONATED_OBJECT",			// MP_CONCEPT_DETONATED_OBJECT 
	"KilledZombie",			// MP_CONCEPT_KILLED_PLAYER
	"TLK_KILLED_OBJECT",			// MP_CONCEPT_KILLED_OBJECT
	"Pain",				// MP_CONCEPT_PLAYER_PAIN
	"FriendlyFire",		// MP_CONCEPT_PLAYER_ATTACKER_PAIN
	"LeadOn",				// MP_CONCEPT_PLAYER_TAUNT
	"PlayerHelp",				// MP_CONCEPT_PLAYER_HELP
	"PlayerEmphaticGo",				// MP_CONCEPT_PLAYER_GO
	"PlayerBackUp",			// MP_CONCEPT_PLAYER_MOVEUP
	"TLK_PLAYER_LEFT",				// MP_CONCEPT_PLAYER_LEFT
	"TLK_PLAYER_RIGHT",				// MP_CONCEPT_PLAYER_RIGHT
	"PlayerYes",				// MP_CONCEPT_PLAYER_YES
	"PlayerNo",				// MP_CONCEPT_PLAYER_NO
	"PlayerIncoming",			// MP_CONCEPT_PLAYER_INCOMING
	...
	"PlayerLaugh"	,			// MP_CONCEPT_PLAYER_TAUNTS
	"ThrewGrenade",			// MP_CONCEPT_PLAYER_BATTLECRY
	"PlayerHurrah",			// MP_CONCEPT_PLAYER_CHEERS
	"PlayerTaunt",				// MP_CONCEPT_PLAYER_JEERS
	"TLK_PLAYER_POSITIVE",			// MP_CONCEPT_PLAYER_POSITIVE
	"PlayerNegative",			// MP_CONCEPT_PLAYER_NEGATIVE
	"PlayerNiceShot",			// MP_CONCEPT_PLAYER_NICESHOT
	"PlayerNiceJob",			// MP_CONCEPT_PLAYER_GOODJOB
	...
	"GooedBySpitter",		// MP_CONCEPT_LOST_CONTROL_POINT
	"WarnSpitterIncoming",			// MP_CONCEPT_CAPTURED_POINT
	...
	"PlayerThanks",			// MP_CONCEPT_PLAYER_THANKS
	...
	"SurvivorIncapacitated",					// MP_CONCEPT_STUNNED
	"SurvivorGrabbedLedge",			// MP_CONCEPT_STUNNED_TARGET
	"PlayerIncapacitated",					// MP_CONCEPT_TIRED
	"TLK_BAT_BALL",					// MP_CONCEPT_BAT_BALL
	"TLK_ACHIEVEMENT_AWARD",		// MP_CONCEPT_ACHIEVEMENT_AWARD
	"PlayerVomitInFace",				// MP_CONCEPT_JARATE_HIT
	...
	"PlayerReviveFriend",		// MP_CONCEPT_DUEL_ACCEPTED
	"PlayerReviveFriendCritical",	// MP_CONCEPT_PLAYER_SHOW_ITEM_TAUNT
	...
	"SurvivorDied",		// MP_CONCEPT_MVM_DEFENDER_DIED
	...
	"PlayerWarnSpecial",		// MP_CONCEPT_MVM_SNIPER_CALLOUT
	...
	"introHospital",				// MP_CONCEPT_PLAYER_CAST_FIREBALL
	"introHospital02",			// MP_CONCEPT_PLAYER_CAST_MERASMUS_ZAP
	"introHospital03",			// MP_CONCEPT_PLAYER_CAST_SELF_HEAL
	"hospital03_path03a1",					// MP_CONCEPT_PLAYER_CAST_MIRV
	"hospital03_path08a2",			// MP_CONCEPT_PLAYER_CAST_BLAST_JUMP
	"hospital04_path01a",				// MP_CONCEPT_PLAYER_CAST_STEALTH
	"hospital04_path02a",				// MP_CONCEPT_PLAYER_CAST_TELEPORT
	"hospital05_path01a",		// MP_CONCEPT_PLAYER_CAST_LIGHTNING_BALL
	"hospital05_path01b",		// MP_CONCEPT_PLAYER_CAST_MOVEMENT_BUFF
	"hospital04_path04a",			// MP_CONCEPT_PLAYER_CAST_MONOCULOUS
	"introFarm",			// MP_CONCEPT_PLAYER_CAST_METEOR_SWARM
	"introFarm2",		// MP_CONCEPT_PLAYER_CAST_SKELETON_HORDE
	"introFarm3",		// MP_CONCEPT_PLAYER_CAST_BOMB_HEAD_CURSE

	"introFar4",			// MP_CONCEPT_PLAYER_SPELL_FIREBALL
	"introSmallTown",		// MP_CONCEPT_PLAYER_SPELL_MERASMUS_ZAP
	"IntroSmallTown2",			// MP_CONCEPT_PLAYER_SPELL_SELF_HEAL
	"IntroSmallTown3",				// MP_CONCEPT_PLAYER_SPELL_MIRV
